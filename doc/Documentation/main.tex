...
%Thorsten: This sentence sounds malformed.. 
%maybe: \pt is a program that calculates the sphere of influence of a space usage rule by it's given coordinates.
\pt is a program that calculates the sphere of influence of a space usage rule which coordinates are given. It was developed within the informatiCup, a programming competition for students organized by the German Informatics Society (Gesellschaft für Informatik e.V.). Our team is called isy and consists of Adriana-Victoria Dreyer, Jacqueline Hemminghaus, Jan Pöppel and Thorsten Schodde, four students of the master study course `intelligent systems' at Bielefeld University.
...
\begin{enumerate}
	...
	\begin{itemize}
		\item Python 2.7 \todo{3 auch ok?} %Thorsten: Maybe importent: 32/64 bit?
...
\todol{Unterschiede bei GUI?} %Thorsten: Most packages are published as .zip for windows too. do we need it?
